...
| **SP3** | Empacotamento (bundle do `core.js` nos resources, detecção do `node`), CI Gradle, publicação no JetBrains Marketplace | 🚧 **automação pronta 2026-07-21 — falta smoke humano + primeira submissão manual** (commits 06ae759..1435c27) — Plugin publicado | Não |
